...
class Week extends View
{
    ...
    public function sanitizeStartDate(CarbonInterface $startDate): CarbonInterface
    {
    ...
    public function makeHeader(CarbonPeriod $carbonPeriod): string
    {
        $headerString = '<thead>';
    ...
    public function renderBlocks(CarbonPeriod $carbonPeriod): string
    {
        $today = Carbon::now();
        $content = '';
    ...
    public function renderEvent(Event $event, CarbonInterface $dateTime): string
    {
        $classes = '';
